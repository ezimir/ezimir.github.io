...
let WORK = [
    {
        ...
        employer: 'Django volunteer',
        positions: [
            {
                title: 'translation coordinator',
                projects: [
                    {
                        title: 'Slovak Translation Team',
                        duration: '2017 - now',
                        description: 'coordinate and help with translation effort using Transifex tool',
                    },
                ],
            },
        ],
    }, {
        employer: 'Blogads, LLC',
        positions: [
            {
                title: 'web developer',
                projects: [
                    {
                        title: 'racery.com',
                        duration: '2014 - 2017',
                        description: 'virtual races for companies, charities and clubs',
                        tasks: [
                ...
                projects: [
                    {
                        title: 'pullquote.com',
                        duration: '2012 - 2014',
                        description: 'quote any content on web and share it via twitter using Chrome extension and iOS app',
                        note: 'result of previous prototyping employment period',
                        tasks: [
                ...
                projects: [
                    {
                        title: 'taghive.com',
                        duration: '2011 - 2012',
                        description: 'gamification of tweeting via tagging people',
                        note: 'project discontinued',
                        tasks: [
                            'spec and create Twitter analysis tool using #hashtags as base of processing',
                            'read relevant content from Twitter Stream and Search AP',
                            'develop timeline/volume/heatmap visualisation',
                            'implement badge/award assignment algorhythms based on time, frequency and volume of content',
                        ],
                        tech: [
                        ...
                        title: 'twiangulate.com',
                        duration: '2010 - 2011',
                        description: 'Twitter follower analysis tool',
                        tasks: [
        ...
        employer: 'Micronic s.r.o.',
        positions: [
            {
                title: 'multi purpose programmer',
                projects: [
                    {
                        duration: '2009',
                        tasks: [
        ...
        employer: 'Technical University in Košice',
        positions: [
            {
                title: 'web developer',
                projects: [
